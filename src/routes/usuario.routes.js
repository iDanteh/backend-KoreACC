...
import { getAllPermisos } from '../controllers/usuario.controller.js';
const router = Router();


router.get('/me', authenticateJWT, me);
router.put('/me', authenticateJWT, updateMe);               
router.get('/me/permisos', authenticateJWT, getMyPermisos); 
router.get('/permisos', authenticateJWT, getAllPermisos);
